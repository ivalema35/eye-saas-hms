...
/**
 * 2025_01_02_000005_create_doctors_table.php
 *
 * NOTE: doctors table has been merged into hospital_users table.
 *       This migration creates a minimal stub table so that other
 *       migrations referencing `doctors` via FK constraints can succeed.
