...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .page { width: 210mm; min-height: 297mm; margin: 0 auto; padding: 10mm 12mm 10mm; }

        /* ── Header ── */
        .rx-header { display: flex; align-items: flex-start; justify-content: space-between;
            border-bottom: 2px solid #1B3A5C; padding-bottom: 8px; margin-bottom: 10px; }
        .rx-logo { width: 64px; height: 64px; border-radius: 10px; background: #F8FAFC;
            border: 1px solid #E5E7EB; display: flex; align-items: center; justify-content: center;
            overflow: hidden; margin-right: 10px; }
        .rx-logo img { width: 100%; height: 100%; object-fit: contain; padding: 6px; }
        .rx-logo span { font-size: 26px; color: #1B3A5C; }
        .rx-header-hospital h1 { font-size: 18px; font-weight: 700; color: #1B3A5C; }
        .rx-header-hospital p  { font-size: 10px; color: #555; margin-top: 2px; }
        .rx-header-doctor { text-align: right; font-size: 10px; color: #444; }
        .rx-header-doctor strong { font-size: 12px; color: #1B3A5C; display: block; }

        /* ── Patient Info ── */
        .rx-patient { background: #eef3fb; border: 1px solid #c7d9f5; border-radius: 6px;
            padding: 6px 12px; margin-bottom: 10px; display: flex; flex-wrap: wrap; gap: 14px; }
        .rx-patient-field label { font-size: 8.5px; text-transform: uppercase; letter-spacing: .06em; color: #666; display: block; }
        .rx-patient-field span  { font-weight: 700; font-size: 12px; }

        /* ── Two-column grid ── */
        .rx-grid { display: flex; gap: 8px; align-items: flex-start; }
        .rx-col   { flex: 1; min-width: 0; display: flex; flex-direction: column; gap: 6px; }

        /* ── Section boxes ── */
        .rx-box { border: 1px solid #bfcfe8; border-radius: 4px; overflow: hidden; }
        .rx-box-title {
            background: #1B3A5C; color: #fff;
            font-size: 10px; font-weight: 700; text-transform: uppercase;
            letter-spacing: .07em; padding: 4px 8px;
        }
        .rx-box-body { padding: 6px 8px; }

        /* ── C/O & K/C/O tables ── */
        .cv-label {
            font-size: 9px; font-weight: 700; text-transform: uppercase;
            letter-spacing: .07em; color: #1B3A5C; margin-bottom: 2px; margin-top: 4px;
        }
        .cv-label:first-child { margin-top: 0; }
        table.cv-table { width: 100%; border-collapse: collapse; font-size: 10.5px; margin-bottom: 3px; }
        table.cv-table thead tr { background: #eef3fb; }
        table.cv-table th { padding: 2px 5px; text-align: center; border: 1px solid #c7d9f5;
            font-weight: 600; font-size: 9.5px; color: #1B3A5C; }
        table.cv-table td { padding: 2px 5px; border: 1px solid #c7d9f5; text-align: center; }
        table.cv-table td:first-child { text-align: left; }
        ...
        table.pg-table th { background: #eef3fb; padding: 2px 4px; text-align: center;
            border: 1px solid #c7d9f5; font-weight: 600; font-size: 9.5px; color: #1B3A5C; }
        table.pg-table td { padding: 2px 4px; border: 1px solid #c7d9f5; text-align: center; }
        ...
        table.st-table th { background: #eef3fb; padding: 2px 4px; text-align: center;
            border: 1px solid #c7d9f5; font-weight: 600; font-size: 9.5px; color: #1B3A5C; }
        table.st-table td { padding: 2px 4px; border: 1px solid #c7d9f5; text-align: center; }
        table.st-table td.row-label { font-weight: 700; font-size: 9.5px; color: #475569;
            background: #f5f8ff; width: 18px; }
        .st-add { font-size: 10.5px; margin-top: 3px; color: #1B3A5C; }

        /* ── O/E table ── */
        table.oe-table { width: 100%; border-collapse: collapse; font-size: 10.5px; }
        table.oe-table thead tr { background: #eef3fb; }
        table.oe-table th { padding: 3px 6px; border: 1px solid #c7d9f5;
            font-weight: 700; font-size: 9.5px; color: #1B3A5C; text-align: center; }
        table.oe-table th:first-child { text-align: left; }
        table.oe-table td { padding: 2px 6px; border: 1px solid #c7d9f5; text-align: center; }
        table.oe-table td:first-child { text-align: left; font-weight: 700; font-size: 10px;
        ...
        table.fundus-table thead tr { background: #eef3fb; }
        table.fundus-table th { padding: 3px 6px; border: 1px solid #c7d9f5;
            font-weight: 700; font-size: 9.5px; color: #1B3A5C; text-align: center; }
        table.fundus-table td { padding: 2px 6px; border: 1px solid #c7d9f5; text-align: center; }
        ...
        table.rx-medicines th { background: #1B3A5C; color: #fff; padding: 3px 6px;
        ...
        .rx-followup { font-size: 10.5px; color: #333; }
        .rx-followup strong { color: #1B3A5C; }
        .rx-signature { text-align: right; font-size: 10.5px; }
        .rx-signature .sig-line { border-top: 1px solid #333; width: 130px;
...
<div class="no-print" style="background:#f0f0f0;padding:8px 12mm;display:flex;gap:12px;align-items:center">
    ...
    <a href="javascript:history.back()"
       style="color:#1B3A5C;font-size:13px;text-decoration:none">← Back</a>
</div>
...
<div class="page">
    ...
    <div class="rx-grid">
            ...
            <div class="rx-box">
                ...
                <div class="rx-box-body">
                    ...
                    <table class="cv-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ ($row['since'] ?? '') ? ($row['since'].' '.($row['unit'] ?? '')) : $dash }}</td>
                                <td>{{ $row['eye'] ?? $dash }}</td>
                    ...
                    <table class="cv-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ ($krow['since'] ?? '') ? ($krow['since'].' '.($krow['unit'] ?? '')) : $dash }}</td>
                    ...
                    <div style="margin-top:5px">
                        ...
                        <div class="pg-eye-header" style="margin-top:{{ $loop->first ? '0' : '4px' }}">{{ $eLabel }}</div>
        ...
        <div class="rx-col">
            ...
            <div class="rx-box">
                <div class="rx-box-title">On Examination (O/E)</div>
