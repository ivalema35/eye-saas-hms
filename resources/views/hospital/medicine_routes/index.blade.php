...
<div class="card type-card border-0">
    <div class="medmaster-list-header">
        <h3 class="medmaster-list-title"><i class="bi bi-arrow-right-circle"></i> Mode List</h3>
        <span class="medmaster-list-badge">{{ $routes->count() }} total</span>
    </div>
