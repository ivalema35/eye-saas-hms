    ...
    <form method="POST" action="{{ route('hospital.setup.store', ['slug' => $slug, 'step' => $step]) }}">
        ...
        <div class="wizard-card-body">
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" class="form-input" value="{{ old('name', $tenant->name) }}"
                    required autofocus>
            ...
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:1rem">
                <div class="form-group">
                    ...
                    <input type="text" id="city" name="city" class="form-input" value="{{ old('city', $tenant->city) }}">
            ...
            <div class="form-group">
                ...
                <input type="text" id="admin_phone" name="admin_phone" class="form-input"
                    value="{{ old('admin_phone', $tenant->admin_phone) }}" data-intl-phone placeholder="+919876543210">
                @error('admin_phone') <div class="form-error">{{ $message }}</div> @enderror
            </div>

            <div class="form-group">
                <label class="form-label" for="hospital_address">Full Address</label>
                <textarea id="hospital_address" name="hospital_address" class="form-input" rows="2"
