...
<head>
    ...
    <style>
        body {
            margin: 0;
            font-family: var(--hms-font, 'Inter', sans-serif);
        }
    ...
    <div class="login-page">
        <div class="login-wrap">
            ...
            <div style="text-align:center;margin-bottom:1.25rem">
                <a href="{{ route('home') }}"
                    style="display:inline-flex;align-items:center;gap:.5rem;text-decoration:none;color:#fff;font-size:1rem;font-weight:700">
            ...
            <div class="login-card">
                <div class="login-body">
                    ...
                    <form method="POST" action="{{ route('hospital.password.update', ['slug' => $slug]) }}">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" id="email" name="email"
                                class="form-input @error('email') is-error @enderror" value="{{ old('email', $email) }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" id="password" name="password"
                                class="form-input @error('password') is-error @enderror" placeholder="Min. 8 characters"
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" id="password_confirmation" name="password_confirmation"
                                class="form-input" placeholder="Re-enter password" required autocomplete="new-password">
                        </div>
