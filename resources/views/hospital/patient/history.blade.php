                                                                    ...
                                                                    <div class="row g-2">
                                                                        ...
                                                                        <div class="col-md-6 d-flex flex-column gap-2">
                                                                            ...
                                                                            <div class="cv-box">
                                                                                ...
                                                                                <table class="cv-table">
                                                                                    ...
                                                                                    <tbody>
                                                                                        @forelse($coRows as $cr)
                                                                                            <tr>
                                                                                                <td style="text-align:left">{{ $cr['complaint'] }}
                                                                                                </td>
                                                                                                <td>{{ !empty($cr['since']) ? $cr['since'] . ' ' . ($cr['unit'] ?? '') : '-' }}
                                                                                                </td>
                                                                                                <td>{{ $cr['eye'] ?? '-' }}</td>
                                                                                        ...
                                                                                        @empty
                                                                                            <tr>
                                                                                                <td colspan="4"
                                                                                                    style="text-align:center;color:#94a3b8">—</td>
                                                                                            </tr>
                                                                                        @endforelse
                                                                                    </tbody>
                                                                                </table>
                                                                                    ...
                                                                                    <table class="cv-table">
                                                                                        ...
                                                                                        <tbody>
                                                                                            @foreach($kcoRows as $kr)
                                                                                                <tr>
                                                                                                    <td style="text-align:left">{{ $kr['condition'] }}
                                                                                                    </td>
                                                                                                    <td>{{ !empty($kr['since']) ? $kr['since'] . ' ' . ($kr['unit'] ?? '') : '-' }}
                                                                                                    </td>
                                                                                                    <td style="text-align:left">
                                                                                                        {{ $kr['comment'] ?? '-' }}
                                                                                                    </td>
                                                                                ...
                                                                                <div
                                                                                    style="border-top:1px solid #dee2e6;padding-top:4px;margin-top:3px;display:flex;flex-wrap:wrap;align-items:center;gap:4px;font-size:11px;">
                                                                                    <span
                                                                                        class="cv-vn-line"><strong>Vn</strong>&nbsp;{{ $cv($vision['vn_re'] ?? '') }}/{{ $cv($vision['vn_le'] ?? '') }}</span>
                                                                                    <span
                                                                                        class="cv-vn-line"><strong>PH</strong>&nbsp;{{ $cv($vision['pnvn_re'] ?? '') }}/{{ $cv($vision['pnvn_le'] ?? '') }}</span>
                                                                                    <span
                                                                                        class="cv-vn-line"><strong>NrVn</strong>&nbsp;{{ $cv($vision['nrvn_re'] ?? '') }}/{{ $cv($vision['nrvn_le'] ?? '') }}</span>
                                                                                    <span
                                                                                        class="cv-vn-line"><strong>IOP:</strong>&nbsp;{{ $cv($nct['iop_re'] ?? '') }}/{{ $cv($nct['iop_le'] ?? '') }}</span>
                                                                                </div>
                                                                            ...
                                                                            <div class="cv-box">
                                                                                ...
                                                                                @if(!empty($st['re']['add']) || !empty($st['le']['add']))
                                                                                    <div style="font-size:10px;color:#475569;margin:3px 0">
                                                                                        <span
                                                                                            style="color:#1B4F72;font-weight:700;">ADD</span>&emsp;RE:
                                                                                ...
                                                                                @if(count($stBadges))
                                                                                    <div style="margin-bottom:4px">
                                                                                        @foreach($stBadges as $b)<span
                                                                                        class="cv-badge">{{ $b }}</span>@endforeach
                                                                                    </div>
                                                                                @endif
                                                                                ...
                                                                                <table class="cv-table">
                                                                                    ...
                                                                                    <tbody>
                                                                                        ...
                                                                                        @empty
                                                                                            <tr>
                                                                                                <td colspan="4"
                                                                                                    style="text-align:center;color:#94a3b8">No
                                                                                                    medicines</td>
                                                                                            </tr>
                                                                                        @endforelse
                                                                                    </tbody>
                                                                                ...
                                                                                <table class="cv-table">
                                                                                    ...
                                                                                    <tbody>
                                                                                        @foreach(['sac' => 'SAC', 'lid' => 'LID', 'conj' => 'CONJ', 'cornea' => 'CORNEA', 'ac' => 'AC', 'iris' => 'IRIS', 'pupil' => 'PUPIL', 'lens' => 'LENS', 'em' => 'EM', 'covertest' => 'COVERTEST', 'other' => 'OTHER'] as $k => $lbl)
                                                                                            <tr>
                                                                                                <th
                                                                                                    style="text-align:left;background:#f0f4f8;color:#1B4F72">
                                                                                                    {{ $lbl }}
                                                                                                </th>
                                                                                                <td>{{ $cv($oe[$k . '_re'] ?? '') }}</td>
                                                                                                <td>{{ $cv($oe[$k . '_le'] ?? '') }}</td>
