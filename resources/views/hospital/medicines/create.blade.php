...
@section('page-header', 'Add Medicine')
            ...
            <div class="card premium-form-card border-0 shadow-sm">
                <div class="card-header bg-white border-bottom py-3">
                    <h5 class="mb-0 fw-bold" style="color: var(--color-primary);">
                        <i class="bi bi-capsule me-2"></i> New Medicine
                    </h5>
                </div>
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('hospital.medicines.store', ['slug' => $slug]) }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text text-muted" style="font-size:.75rem">Add Tab / Caps / Oint etc. at the end
                                of name</div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="price" step="0.01" min="0" value="{{ old('price', '0.00') }}"
