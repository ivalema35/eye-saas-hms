                ...
                <div style="margin-bottom:2.5rem">
                    ...
                    <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:1.25rem">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="middle_name" value="{{ old('middle_name', $patient->middle_name) }}"
                                placeholder="e.g. Kumar" class="form-control hms-input">
                        </div>
                    </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div style="display:flex;gap:.5rem;align-items:center">
                                    <select name="location_id" id="locationSelect"
                                        class="form-select select2 hms-select @error('location_id') is-invalid @enderror"
                                        required>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="gender" class="form-control hms-select @error('gender') is-invalid @enderror"
                                required>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="occupation" value="{{ old('occupation', $patient->occupation) }}"
                                class="form-control hms-input" placeholder="e.g. Farmer, Teacher">
                        </div>
                    </div>
                </div>
