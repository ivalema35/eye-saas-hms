...
@section('page-actions')
    <button type="button" class="btn btn-outline-primary btn-sm group-show-action-btn group-show-edit-btn"
        ...
        <div class="card premium-card border-0 shadow-sm group-show-card">
            <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center flex-wrap gap-3">
                <div class="group-show-title-wrap">
                    ...
                    <div>
                        <h5 class="mb-0 fw-bold group-show-title" style="color: var(--color-primary);">{{ $group->name }}
                        </h5>
                        @if($group->group_code)
                        ...
                        @if($group->diagnosis)
                            <div class="mt-1">
                                <span
                                    style="font-size:.75rem;font-weight:700;color:#0d6949;background:rgba(13,105,73,.08);border:1px solid rgba(13,105,73,.2);border-radius:999px;padding:.18rem .6rem;">
