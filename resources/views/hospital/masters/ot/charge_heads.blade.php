...
<div class="ot-master-page">
    <div class="ot-master-toolbar">
        ...
        <button type="button"
                ...
                data-bs-target="#chargeFormModal"
                onclick="resetForm()">
                ...
                <form id="chargeForm" method="POST" action="{{ route('hospital.masters.ot.charge-heads.store', ['slug' => $slug]) }}">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" name="charge_name" id="charge_name" class="form-control form-control-lg ot-master-input" value="{{ old('charge_name') }}" required>
                        </div>

                        <div class="mb-3">
                            <label class="form-label text-muted small fw-bold text-uppercase">Percentage</label>
                            <input type="number" step="0.01" min="0" max="100" name="percentage" id="percentage" class="form-control form-control-lg ot-master-input" value="{{ old('percentage') }}" required>
                        </div>
                    ...
                    <div class="modal-footer border-0 gap-2">
                        ...
                        <button class="btn btn-primary fw-semibold rounded-3" type="submit" id="submitBtn">Save Charge Head</button>
                    </div>
                </form>
            </div>
        </div>
