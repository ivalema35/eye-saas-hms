...
<div class="ot-master-page">
    <div class="ot-master-toolbar">
        ...
        <button type="button"
                ...
                data-bs-target="#surgeryFormModal"
                onclick="resetForm()">
                ...
                <form id="surgeryForm" method="POST" action="{{ route('hospital.masters.ot.surgery-types.store', ['slug' => $slug]) }}">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <select name="ot_type_id" id="ot_type_id" class="form-select form-select-lg ot-master-input" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="surgery_name" id="surgery_name" class="form-control form-control-lg ot-master-input" value="{{ old('surgery_name') }}" required>
                        </div>
                    </div>

                    <div class="modal-footer border-0 gap-2">
                        <button class="btn btn-outline-secondary rounded-3" type="button" id="cancelBtn" data-bs-dismiss="modal">Cancel</button>
                        <button class="btn btn-primary fw-semibold rounded-3" type="submit" id="submitBtn">Save Surgery Type</button>
                    </div>
                </form>
            </div>
        </div>
