                        ...
                        <tr>
                            ...
                            <td class="text-end pe-4">
                                <div class="btn-group shadow-sm rounded-3" role="group">
                                    ...
                                    <form method="POST" class="d-inline" action="{{ route('hospital.masters.ot.types.destroy', ['slug' => $slug, 'id' => $record->id]) }}" onsubmit="return confirm('Delete this OT type?');">
                                        @csrf
                                        @method('DELETE')
    ...
    <div class="modal fade ot-master-modal" id="typeFormModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0">
                ...
                <form id="typeForm" method="POST" action="{{ route('hospital.masters.ot.types.store', ['slug' => $slug]) }}">
                    @csrf
                    ...
                    <div class="modal-footer border-0 gap-2">
                        ...
                        <button class="btn btn-primary fw-semibold rounded-3" type="submit" id="submitBtn">Save Type</button>
                    </div>
                </form>
            </div>
        </div>
