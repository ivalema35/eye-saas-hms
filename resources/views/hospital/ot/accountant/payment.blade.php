        ...
        <div class="row justify-content-center">
            <div class="col-xl-10">
                <div class="card ot-basic-card shadow-sm mb-4">
                    <div
                        class="card-body d-flex flex-column flex-md-row justify-content-between gap-2 align-items-md-center">
                        <div>
                        ...
                        <div class="card ot-basic-card shadow-sm">
                            ...
                            <div class="card-body p-4">
                                <form method="POST"
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <input type="text" name="receipt_number" id="receipt_number"
                                                value="{{ old('receipt_number') }}" class="form-control"
                                    ...
                                    <div
                                        class="d-flex flex-column flex-sm-row justify-content-end gap-2 mt-4 pt-3 border-top">
