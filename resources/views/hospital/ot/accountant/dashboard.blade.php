...
@push('styles')
    <style>
        ...
        .ota-card-header {
            background: var(--ot-secondary, var(--ota-secondary)) !important;
        ...
        .ota-table-wrap .dataTables_length select.form-select,
        .ota-table-wrap .dataTables_length select {
            border: 1px solid var(--ota-secondary-18) !important;
            border-radius: 8px;
            font-size: .85rem;
        ...
        .ota-table-wrap .dataTables_length select:focus {
            outline: none;
            border-color: var(--ota-secondary);
            box-shadow: 0 0 0 .18rem var(--ota-secondary-12);
        }
        ...
        .ota-table-wrap .dataTables_paginate .paginate_button:hover {
            background: var(--ota-secondary-08) !important;
            border-color: var(--ota-secondary-18) !important;
            color: var(--ota-secondary) !important;
        }
        ...
        .otaAccountant-table thead tr,
        .otaAccountant-table thead th {
        ...
        .otaAccountant-table thead th {
            ...
            border: 0 !important;
            border-bottom: 2px solid var(--ota-secondary-12) !important;
        ...
        .otaAccountant-table thead th.text-end,
        .otaAccountant-table tbody td.text-end {
            text-align: end;
        }

        .otaAccountant-table tbody td {
            ...
            border: 0 !important;
            border-bottom: 1px solid var(--ota-secondary-08) !important;
            border-radius: 0 !important;
        }

        .otaAccountant-table tbody tr:nth-child(even) td {
            background: #f7fbfe !important;
        }

        .otaAccountant-table tbody tr:hover td {
            background: var(--ota-secondary-06) !important;
        }
        ...
        .ota-status-badge.text-bg-info {
            background: #E9F3FB !important;
            color: #2E86C1 !important;
            border-color: #AED4F0 !important;
        }

        .ota-status-badge.text-bg-secondary {
            background: #EEF0F2 !important;
            color: #5D6D7E !important;
            border-color: #C7CCD1 !important;
        }

        .ota-status-badge.text-bg-danger {
            background: #FCEAEA !important;
            color: #C0392B !important;
            border-color: #F0B3AC !important;
        }
        ...
        .ota-paid-note {
            ...
            align-items: center;
            gap: .35rem;
            background: var(--ota-secondary-06);
            border: 1px solid var(--ota-secondary-12);
            color: var(--ota-secondary) !important;
            border-radius: 8px;
            padding: .4rem .75rem;
...
@push('scripts')
    {{-- Payment/Refund queue table: client-side DataTable (search box,
    page-length, and pagination) — mirrors the pattern used on the OT
    Appointments / Ward Management / OT Assistant / Billing index pages. --}}
    <script>
        $(function () {
            ...
            $table.DataTable({
                ...
                language: {
                    ...
                    emptyTable: 'No bookings in payment queue.',
