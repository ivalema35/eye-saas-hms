            ...
            <div class="ot-card-header">
                <div class="ot-title-wrap">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <div class="ot-subtitle">Pre-registration appointments booked over phone/walk-in/online/referral.
                        </div>
                    </div>
                </div>
                <div class="d-flex align-items-center gap-2 flex-wrap">
                    <form method="GET" action="{{ route('hospital.ot.appointments.index', ['slug' => $slug]) }}"
                        class="ot-search-form d-flex gap-2">
                        <input type="text" name="search" value="{{ request('search') }}"
                            class="form-control form-control-sm ot-search-input" placeholder="Name / Mobile / APT-000123">
                        <select name="status" class="form-select form-select-sm ot-search-select"
                    ...
                    <span class="badge ot-total-pill"><i class="bi bi-collection me-1"></i>{{ $appointments->total() }}
                        total</span>
                </div>
            </div>
                                            ...
                                            @if(in_array($appointment->status, ['booked', 'confirmed']))
                                                ...
                                                @if($appointment->status === 'booked')
                                                    <form method="POST"
                                                        ...
                                                        class="d-inline">
                                                        @csrf
                                                        <button type="submit" class="btn btn-sm ot-icon-btn ot-icon-btn-confirm me-1"
...
@push('styles')
    <style>
        ...
        */
        ...
        .ot-premium-table tbody tr:nth-child(1) {
            animation-delay: 20ms;
        }

        .ot-premium-table tbody tr:nth-child(2) {
            animation-delay: 40ms;
        }

        .ot-premium-table tbody tr:nth-child(3) {
            animation-delay: 60ms;
        }

        .ot-premium-table tbody tr:nth-child(4) {
            animation-delay: 80ms;
        }

        .ot-premium-table tbody tr:nth-child(5) {
            animation-delay: 100ms;
        }

        .ot-premium-table tbody tr:nth-child(6) {
            animation-delay: 120ms;
        }

        .ot-premium-table tbody tr:nth-child(7) {
            animation-delay: 140ms;
        }

        .ot-premium-table tbody tr:nth-child(8) {
            animation-delay: 160ms;
        }

        .ot-premium-table tbody tr:nth-child(9) {
            animation-delay: 180ms;
        }

        .ot-premium-table tbody tr:nth-child(10) {
            animation-delay: 200ms;
        }

        .ot-premium-table tbody tr:nth-child(11) {
            animation-delay: 220ms;
        }

        .ot-premium-table tbody tr:nth-child(12) {
            animation-delay: 240ms;
        }

        .ot-premium-table tbody tr:nth-child(13) {
            animation-delay: 260ms;
        }

        .ot-premium-table tbody tr:nth-child(14) {
