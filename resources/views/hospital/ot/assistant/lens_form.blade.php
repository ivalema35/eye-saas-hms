                ...
                <div class="card-header ot-lens-card-header border-bottom-0">
                    <div class="ot-lens-title-wrap">
                        ...
                        <div>
                            ...
                            <p class="mb-0 text-muted small">Record final lens specification and implantation status.</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="ot-lens-section-body">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control ot-lens-readonly" value="{{ $booking->patient?->full_name ?? '-' }}" readonly>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label text-muted">Patient Code</label>
                                    <input type="text" class="form-control ot-lens-readonly" value="{{ $booking->patient?->patient_code ?? '-' }}" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
