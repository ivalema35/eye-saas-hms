            ...
            <div class="card border-0 shadow-sm ot-surgery-card">
                <div class="card-header ot-surgery-card-header border-bottom-0">
                    <div class="ot-surgery-title-wrap">
                        ...
                        <div>
                            ...
                            <p class="mb-0 text-muted small">Complete surgery details and ward medicines in one flow.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body p-4 p-lg-5">
                        ...
                        <div class="ot-section-body">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control ot-readonly" value="{{ $booking->patient?->full_name ?? '-' }}" readonly>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label text-muted">Phone</label>
                                    <input type="text" class="form-control ot-readonly" value="{{ $booking->patient?->contact_no ?? '-' }}" readonly>
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label text-muted">OT Date</label>
                                    <input type="text" class="form-control ot-readonly" value="{{ optional($booking->surgery_date)->format('d M Y') }}" readonly>
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label text-muted">Package</label>
                                    <input type="text" class="form-control ot-readonly" value="INR {{ number_format((float) ($counselling?->package_amount ?? $booking->package_amount ?? 0), 2) }}" readonly>
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label text-muted">Mediclaim</label>
                                    <input type="text" class="form-control ot-readonly" value="{{ ($counselling?->mediclaim ?? $booking->has_mediclaim) ? 'YES' : 'NO' }}" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <form method="POST" action="{{ route('hospital.ot.surgery.store', ['slug' => $slug, 'bookingId' => $booking->id]) }}">
                        ...
                        <div class="ot-section mb-4">
                            ...
                            <div class="ot-section-body">
                                <div class="row g-3 mb-1">
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label d-block mb-2">Eye Operated <span class="text-danger">*</span></label>
                        ...
                        <div class="ot-section mb-4">
                            <div class="ot-section-header d-flex align-items-center justify-content-between gap-2 flex-wrap">
