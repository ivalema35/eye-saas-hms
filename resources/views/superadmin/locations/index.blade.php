            ...
            <div class="filter-bar">
                <form method="GET" action="{{ route('superadmin.locations.index') }}"
                    ...
                    <div class="hms-form-group" style="margin-bottom:0;min-width:200px">
                        <label class="hms-label" style="color: #ffffff;">Country <span style="color:#E53E3E">*</span></label>
                    ...
                    <div style="display:flex;gap:.5rem">
                        <button type="submit" class="hms-btn hms-btn-primary hms-btn-sm" style="color: #1b4f72;"><i class="bi bi-search"></i>
                            Filter</button>
