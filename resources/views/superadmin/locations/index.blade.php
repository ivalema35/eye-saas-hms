...
@section('content')
    ...
    <div class="hms-card" style="padding:0">
        ...
        @else
            <div class="hms-table-wrap" style="border:none">
                <table class="hms-table">
                    <thead><tr><th>#</th><th>Country</th><th>State</th><th>Districts</th><th>Status</th><th class="text-end">Actions</th></tr></thead>
                    <tbody>
    ...
    <div class="hms-card" style="padding:0">
        ...
        @else
            <div class="hms-table-wrap" style="border:none">
                <table class="hms-table">
                    <thead><tr><th>#</th><th>Country</th><th>State</th><th>District Name</th><th>Cities</th><th>Status</th><th class="text-end">Actions</th></tr></thead>
                    <tbody>
    ...
    <div class="hms-card" style="padding:0">
        ...
        @else
            <div class="hms-table-wrap" style="border:none">
                <table class="hms-table">
                    <thead><tr><th>#</th><th>Country</th><th>State</th><th>District</th><th>City / Village</th><th>Status</th><th class="text-end">Actions</th></tr></thead>
                    <tbody>
