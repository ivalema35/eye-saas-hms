            ...
            <div style="padding:1.375rem">
                <form method="POST" action="{{ route('superadmin.profile.update') }}">
                    ...
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem">
                        <div class="hms-form-group">
                            ...
                            <input type="text" name="name" class="hms-input @error('name') is-invalid @enderror"
                                value="{{ old('name', $admin->name) }}" placeholder="Super Admin Name">
                            @error('name')
                        ...
                        <div class="hms-form-group">
                            ...
                            <input type="email" name="email" class="hms-input @error('email') is-invalid @enderror"
                                value="{{ old('email', $admin->email) }}" placeholder="admin@eyehms.com">
                            @error('email')
                                <span class="hms-error">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="hms-form-group" style="margin-top:.5rem">
                        ...
                        <input type="text" class="hms-input" value="{{ ucfirst($admin->role ?? 'superadmin') }}" readonly
                ...
                <form method="POST" action="{{ route('superadmin.profile.password') }}">
                    ...
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;margin-top:.75rem">
                        ...
                        <div class="hms-form-group">
                            ...
                            <div style="position:relative">
                                <input type="password" name="password_confirmation" id="confirmPwd" class="hms-input"
                    ...
                    <button type="submit" class="hms-btn hms-btn-primary" style="margin-top:1.25rem;color: #1b4f72;">
