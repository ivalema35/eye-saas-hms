    ...
    <div class="hms-card" style="padding:1.25rem;margin-bottom:1.25rem">
        ...
        <form method="GET" style="display:flex;gap:.75rem;flex-wrap:wrap;align-items:flex-end">
            ...
            <div class="hms-form-group" style="margin-bottom:0;min-width:220px">
                ...
                <input type="text" class="hms-input" data-hms-date-range data-start-name="from" data-end-name="to"
                    data-start-value="{{ request('from') }}" data-end-value="{{ request('to') }}" data-auto-submit="1"
                    placeholder="Select start → end date" autocomplete="off" readonly style="width:220px">
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($payment->method === 'online')
                                    <span class="hms-badge hms-badge-info"><i class="bi bi-wifi" style="font-size:.6rem"></i>
                                        Online</span>
                                @else
                                    <span class="hms-badge" style="background:#FFF3E0;color:#E65100"><i class="bi bi-cash-stack"
                                            style="font-size:.6rem"></i> Offline</span>
                                @endif
                            </td>
                            ...
                            <td style="text-align:center">
                                @if($payment->status === 'success')
                                    <a href="{{ route('superadmin.payments.invoice', $payment) }}" target="_blank"
...
@push('modals')
    {{-- Record Offline Payment Modal — rendered at

    <body> level to avoid .sa-main transform stacking context --}}
                    ...
                    <form method="POST" action="{{ route('superadmin.payments.offline') }}">
                        ...
                        <div class="modal-body" style="padding:1.5rem">
                            ...
                            <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem">
                                <div class="hms-form-group">
                                    <label class="hms-label">Amount ({{ platform_currency_symbol() }}) <span
                                            style="color:#C0392B">*</span></label>
                                    <input type="number" name="amount" class="hms-input" min="1" step="1"
                            ...
                            <div class="hms-form-group">
                                ...
                                <input type="text" name="transaction_id" class="hms-input"
                                    placeholder="e.g. CHQ-12345 or UTR-XXXXX">
                            </div>
                            <div class="hms-form-group" style="margin-bottom:0">
                                <label class="hms-label">Notes (optional)</label>
                                <input type="text" name="notes" class="hms-input"
                                    placeholder="e.g. Cash received by X on dd/mm/yyyy">
                            </div>
                        </div>
