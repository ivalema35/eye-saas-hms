        ...
        <tr>
            <td style="padding:30px 15px">
                <table role="presentation" cellspacing="0" cellpadding="0"
                    style="max-width:600px;margin:0 auto;width:100%;border-collapse:collapse">
                    ...
                    <tr>
                        <td style="background-color:#1B4F72;padding:24px 30px;border-radius:10px 10px 0 0">
                            ...
                            <div style="font-size:12px;color:#A8D8EA;margin-top:3px">Platform Administration — Important
                                Notice</div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="background-color:#2980B9;padding:12px 30px">
                            <span
                                style="font-size:13px;font-weight:bold;color:#FFFFFF">{{ $notificationSubject }}</span>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="background-color:#FFFFFF;padding:30px">
                            ...
                            <div style="font-size:14px;color:#1A202C;line-height:1.7;white-space:pre-wrap">
                                {{ $notificationBody }}
                            </div>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" width="100%"
                                style="background:#F0F4F8;border-radius:6px;border-collapse:collapse">
                                <tr>
                                    <td style="padding:14px 16px">
                                        <div
                                            style="font-size:11px;color:#4A5568;font-weight:bold;letter-spacing:0.5px;margin-bottom:8px;text-transform:uppercase">
                                            Your Hospital</div>
                                        <table role="presentation" cellspacing="0" cellpadding="0"
                                            style="border-collapse:collapse">
                                            <tr>
                                                <td style="font-size:12px;color:#4A5568;padding-bottom:4px;width:110px">
                                                    Hospital</td>
                                                <td
                                                    style="font-size:12px;font-weight:600;color:#1A202C;padding-bottom:4px">
                                                    {{ $tenant->name }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="font-size:12px;color:#4A5568;padding-bottom:4px">Login URL
                                                </td>
                                                <td style="font-size:12px;color:#2980B9;padding-bottom:4px">
