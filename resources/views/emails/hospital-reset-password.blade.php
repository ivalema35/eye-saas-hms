...
<table width="100%" cellpadding="0" cellspacing="0" style="background:#F4F6F9;padding:40px 20px">
    <tr>
        <td align="center">
            <table width="600" cellpadding="0" cellspacing="0" style="background:#FFFFFF;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,.08);overflow:hidden">
                {{-- Header --}}
                <tr>
                    <td style="background:linear-gradient(135deg,#0D2137,#1B4F72);padding:28px 32px;text-align:center">
                ...
                <tr>
                    <td style="padding:32px">
                        ...
                        <table cellpadding="0" cellspacing="0" style="margin:24px 0">
                            <tr>
                                <td style="background:#1B4F72;border-radius:8px;padding:14px 32px;text-align:center">
                                    <a href="{{ $url }}"
