    ...
    <div class="auth-shell">
        ...
        <div class="auth-form-side">
            <div class="auth-form-box">
                ...
                <div class="role-badge"><i class="fa-solid fa-users"></i> Admin &bull; Doctor &bull; Receptionist &bull; OT Staff</div>
                    ...
                    <div class="form-group">
                        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:.2rem;">
                            ...
                            @if (Route::has('password.request'))
                                <a href="{{ route('password.request') }}" class="forgot-link" style="font-size:.85rem;color:#2980B9;text-decoration:none;">Forgot Password?</a>
                            @else
