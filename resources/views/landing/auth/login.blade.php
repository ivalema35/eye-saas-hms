...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .auth-banner {
            flex: 1;
            background: linear-gradient(135deg, #060E1A 0%, #0D2137 55%, #1B4F72 100%);
            color: white;
            display: flex;
        ...
        .banner-content p { font-size: 1rem; color: rgba(255,255,255,.65); margin: 0 0 2rem; line-height: 1.6; }
        .banner-features { list-style: none; padding: 0; margin: 0; text-align: left; }
        .banner-features li { display: flex; align-items: center; gap: .625rem; font-size: .875rem; color: rgba(255,255,255,.7); padding: .35rem 0; }
        .banner-features li i { font-size: .7rem; color: rgba(255,255,255,.4); width: 14px; text-align: center; }
        ...
        .alt-links { display: flex; justify-content: space-between; font-size: .8125rem; }
        .alt-links a { display: flex; align-items: center; gap: .35rem; text-decoration: none; color: #2980B9; transition: color .2s; }
        .alt-links a:hover { color: #154360; }
        .alt-links a.admin-link { color: #64748B; }
        .alt-links a.admin-link:hover { color: #0D2137; }
        .form-footer { text-align: center; margin-top: 1.5rem; font-size: .75rem; color: #9CA3AF; }
        ...
        <div class="auth-form-box">
            ...
            <div class="alt-links">
                <a href="{{ route('register.show') }}">
                    <i class="fa-solid fa-rocket"></i> Register Hospital
                </a>
