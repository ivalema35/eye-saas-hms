                        ...
                        <div class="reg-section">
                                ...
                                @enderror
                                                    ...
                                                    <div class="hms-form-group">
                                                        ...
                                                        <div class="slug-input-wrap">
                                                            ...
                                                            <input type="text" name="slug" id="slugInput" class="slug-input-field @error('slug') is-invalid @enderror"
                                                                value="{{ old('slug') }}" placeholder="vision-eye-centre" required pattern="[a-z0-9\-]+" minlength="3"
                                                                maxlength="30">
                                                        </div>
                            ...
                            <div class="hms-form-group">
                                ...
                                <div style="display:flex;align-items:center;gap:.75rem">
                                    ...
                                    <span style="color:var(--hms-text-muted);font-size:.85rem">MRD preview: <strong id="mrdPreview" style="color:var(--hms-primary)">---0001</strong></span>
                                </div>
