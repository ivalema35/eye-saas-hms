 ...
 *
 * PERMISSIONS: report_view|ot_reports_view (index/show), report_export|ot_reports_export (export)
 */
...
class OtReportController extends Controller
{
    ...
    {
        $this->authorizeAnyPermission(['report_view', 'ot_reports_view']);
    ...
    {
        $this->authorizeAnyPermission(['report_export', 'ot_reports_export']);
